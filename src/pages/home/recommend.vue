    ...
    <ul class="recommend-list" v-else>
      ...
      >
        ...
        params: {
          ...
          pic: item.baseinfo.picUrlFromIc,
          name: item.name.longName,
          price: item.price.actPrice,
          count: item.remind.soldCount,
          sellerName: item.extend.shopTitle,
          infoFirst: item.jiaZhuang.customerService,
          infoSecond: item.jiaZhuang.supplyChannel}}" >
